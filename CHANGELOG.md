...
- *(deps)* Bump opentelemetry-prometheus from 0.15.0 to 0.16.0 (b98cc03)
- *(deps)* Bump opentelemetry from 0.22.0 to 0.23.0 (8878d0c)
- *(deps)* Bump opentelemetry_sdk from 0.22.1 to 0.23.0 (bad63b9)
- *(deps)* Bump prometheus from 0.13.3 to 0.13.4 (8f60d6e)
- *(deps)* Bump opentelemetry-semantic-conventions (b5161be)
- *(deps)* Update opentelemetry requirement from 0.23 to 0.24 (2b4e112)
- *(deps)* Update opentelemetry-otlp requirement from 0.16.0 to 0.17.0 (ec7b8cc)
- *(deps)* Update opentelemetry-semantic-conventions requirement (086e778)
- *(deps)* Update opentelemetry-http requirement from 0.12.0 to 0.13.0 (ea95cda)
- *(deps)* Update opentelemetry_sdk requirement from 0.23.0 to 0.24.1 (05a9e20)
...
- *(deps)* Bump axum from 0.7.1 to 0.7.2 (5f69bbb)
- *(deps)* Bump tokio from 1.34.0 to 1.35.0 (68ab9cc)
- *(deps)* Bump opentelemetry_sdk from 0.21.1 to 0.21.2 (7cff731)
- *(deps)* Bump axum from 0.7.2 to 0.7.3 (eb3d273)
- *(deps)* Bump futures-util from 0.3.29 to 0.3.30 (30efdbf)
- *(deps)* Bump axum from 0.7.3 to 0.7.4 (de6db16)
- *(deps)* Bump h2 from 0.4.0 to 0.4.2 (a53ab19)
- *(deps)* Bump tokio from 1.35.0 to 1.36.0 (d43c6b3)
- *(deps)* Bump h2 from 0.4.0 to 0.4.2 in /examples/axum-metrics-demo (8f58e36)
- *(deps)* Bump opentelemetry from 0.21.0 to 0.22.0 (8e0bb64)
- *(deps)* Bump mio in /examples/axum-metrics-demo (4806758)
- *(deps)* Bump mio from 0.8.10 to 0.8.11 (ec21677)
- *(deps)* Bump opentelemetry_sdk from 0.22.0 to 0.22.1 (9709ebd)
- *(deps)* Bump http from 1.0.0 to 1.1.0 (46952d9)
- *(deps)* Bump axum from 0.7.4 to 0.7.5 (533291d)
- *(deps)* Bump tokio from 1.36.0 to 1.37.0 (cede9fe)
- *(deps)* Bump pin-project-lite from 0.2.13 to 0.2.14 (55d0a98)
- *(deps)* Bump h2 from 0.4.2 to 0.4.4 in /examples/axum-metrics-demo (9ba9951)
...
- *(deps)* Bump http from 0.2.9 to 0.2.10 (65d15fb)
- *(deps)* Bump tokio from 1.33.0 to 1.34.0 (43d09f0)
- *(deps)* Bump opentelemetry-prometheus from 0.13.0 to 0.14.0 (e3dda91)
- *(deps)* Bump opentelemetry-semantic-conventions (288f0b7)
- *(deps)* Bump opentelemetry_sdk from 0.21.0 to 0.21.1 (a59a3a6)
- *(deps)* Bump opentelemetry-prometheus from 0.14.0 to 0.14.1 (bef9101)
...
- *(deps)* Bump tokio from 1.31.0 to 1.32.0 (2ba5084)
- *(deps)* Bump pin-project-lite from 0.2.12 to 0.2.13 (ff00131)
- *(deps)* Bump tokio from 1.32.0 to 1.33.0 (2fa6d3a)
...
- *(deps)* Bump tokio from 1.28.1 to 1.28.2 (2c3cbea)
- *(deps)* Bump opentelemetry from `0a893ce` to `00641fb` (a415547)
- *(deps)* Bump tokio from 1.28.2 to 1.29.1 (8c87742)
- *(deps)* Bump pin-project-lite from 0.2.9 to 0.2.10 (bd277ab)
- *(deps)* Bump opentelemetry from `34c7332` to `ccb510f` (cadc602)
- *(deps)* Bump opentelemetry-prometheus from `ccb510f` to `fb14199` (ecbb40f)
...
- *(deps)* Bump tokio from 1.26.0 to 1.27.0 (6143010)
- *(deps)* Bump opentelemetry from 0.18.0 to 0.19.0 (9292f94)
...
- *(deps)* Bump axum from 0.6.0 to 0.6.1 (b802f2b)
- *(deps)* Bump tokio from 1.22.0 to 1.23.0 (438c992)
- *(deps)* Bump tokio in /examples/axum-metrics-demo (53c66dc)
- *(deps)* Bump tokio from 1.23.0 to 1.23.1 (f2890fb)
- *(deps)* Bump tokio from 1.23.1 to 1.24.1 (4bb1fcd)
- *(deps)* Bump futures-util from 0.3.25 to 0.3.27 (0185cdb)
- *(deps)* Bump tokio from 1.24.1 to 1.25.0 (e784605)
- *(deps)* Bump axum from 0.6.1 to 0.6.9 (b232659)
...
- *(deps)* Bump prometheus from 0.13.2 to 0.13.3 (9fce58d)
- *(deps)* Bump futures-util from 0.3.24 to 0.3.25 (1bf8f19)
- *(deps)* Bump axum from 0.6.0-rc.2 to 0.6.0-rc.4 (a8a6b72)
