...
- Add default configuration for git-cliff (d084c33)
- Add changelog command to Makefile (949f5a5)
- *(metrics)* Add custom bucket support for http metrics layer (f11cb2b)

### 🚜 Refactor

- [**breaking**] Remove provider configuration from builder logic (27dcc66)
- *(metrics)* Remove requests_total counter and related code (dbd5965)
- Derive default for HttpMetricsLayerBuilder (05d649e)

### 📚 Documentation

- Update changelog template formatting (c8bfcdc)

### ⚙️ Miscellaneous Tasks

- Fix typo (21aee4e)
- Update dependencies in Cargo.toml (9040be1)
- Update CHANGELOG.md (9353960)
- Update CHANGELOG.md (21f866c)
